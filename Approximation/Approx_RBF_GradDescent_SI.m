...
final_weights = zeros(1,10,4);           %out , hidden , set 
final_centers = zeros(10,2,4);           % hidden, input , set
final_sigma = zeros(10,1,4);            % hidden , output , set
...
epo = 50;
lrw = 1e-01;        % Learning rate for weights
lrs = 1e-02;        % Learning rate for sigma
...
save -ascii rbfSimple_SI19.dat res_tes;
% disp('Testing Error');
